...
const FeaturedStoryCard: React.FC<FeaturedStoryCardProps> = ({ story }) => (
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-center bg-white rounded-lg p-4 sm:p-6 md:p-8 shadow-sm border border-gray-200 overflow-hidden mb-8 sm:mb-10">
    <div className="relative h-48 sm:h-64 md:h-80 rounded-lg overflow-hidden">
      ...
      />
      <span className="absolute top-3 left-3 z-10 bg-black/80 text-white text-xs font-bold px-3 py-1 rounded-full shadow">Latest</span>
    </div>
    <div className="space-y-3 sm:space-y-4">
      ...
      <a href={story.link} className="inline-flex items-center gap-2 text-blue-600 font-semibold hover:gap-3 transition-all duration-200 mt-2 sm:mt-4 group">
        Read More
